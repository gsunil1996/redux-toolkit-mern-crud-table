...
import { addCompanyData } from '../../redux/features/companiesTableSlice';
import { addCompanyLoading } from '../../redux/features/companiesTableSlice';
import { addCompanyErrorStatus } from '../../redux/features/companiesTableSlice';
import { addCompanyError } from '../../redux/features/companiesTableSlice';
import { addCompanySuccess } from '../../redux/features/companiesTableSlice';
import { addCompanyTableData } from '../../redux/features/companiesTableSlice';
import { resetAddCompany } from '../../redux/features/companiesTableSlice';
...
const AddCompany = (props) => {
    ...
    const data = useSelector(addCompanyData);
    const isLoading = useSelector(addCompanyLoading);
    const isError = useSelector(addCompanyErrorStatus);
    const error = useSelector(addCompanyError);
    const isSuccess = useSelector(addCompanySuccess);

    // console.log("checkAddCompany", data, isLoading, isError, error, isSuccess);
    ...
    const submitCompanyData = (e) => {
        ...
        const companyData = { search: "", gender: "all", status: "all", sort: "new", page: 1 }
        ...
        dispatch(addCompanyTableData(payload))
    }
